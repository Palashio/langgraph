...
# Script to append the test case to test_pregel.py
...
# Append the test to the test_pregel.py file
with open('/home/daytona/langgraph/libs/langgraph/tests/test_pregel.py', 'a') as f:
    f.write(test_code)

print("Test case successfully added to test_pregel.py")
