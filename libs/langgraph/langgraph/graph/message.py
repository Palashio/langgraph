...
def add_messages(left: Messages, right: Messages) -> Messages:
    ...
    # handle RemoveMessage objects - filter out messages with matching IDs
    ids_to_remove = set()
    messages_to_merge = []
    for m in right:
