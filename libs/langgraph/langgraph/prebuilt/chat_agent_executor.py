    ...
    *,
    ...
    Args:
        ...
        response_format: An optional Pydantic model class to use for structured output.
            When provided, the agent will return responses in the specified format
            in the `structured_response` field of the final state. The agent will
            automatically create a tool from this schema and route to a response
            node when the structured output tool is called.
