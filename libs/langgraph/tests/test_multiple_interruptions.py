...
def test_multiple_interruptions_after_resuming(mocker: MockerFixture) -> None:
    ...
    This test demonstrates the bug where after resuming from an interrupt,
    subsequent interruptions don't work because versions_seen[INTERRUPT] 
    is incorrectly updated during resume.
    """
